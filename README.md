...
3. Run the exporter:
   ...
   ```
   For diagnostics without publishing over MQTT, use `--dry-run` and `-v`. Use `-vv` to enable trace logging of CLI tool output; debug/trace modes pretty-print payloads and colorize logs.
